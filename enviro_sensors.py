...
class EnviroSensors:
        ...
        if not use_mock:
            try:
                ...
                try:
                    ...
                    print(f"Warning: BME280 not available: {e}")
                ...
                try:
                    ...
                    print(f"Warning: LTR559 not available: {e}")
                ...
                try:
                    ...
                    print(f"Warning: PMS5003 not available: {e}")
                
                # Gas sensor is available through enviroplus.gas module
                self.gas_sensor = gas
                print("Gas sensors initialized")
                ...
                print(f"WARNING: Enviro+ libraries not available: {e}")
    ...
    def read_gas(self):
        ...
        try:
            ...
            print(f"Error reading gas sensors: {e}")
            return None
    ...
    def read_particulates(self):
        ...
        try:
            ...
            print(f"Error reading particulates: {e}")
            return None
